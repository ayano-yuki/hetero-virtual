...
- [x] Record real comparison evidence for at least one React library under the
  ...
  - Evidence:
    `playground/evidence/2026-06-23/react-virtuoso-fast-scroll-4x.json`,
    `playground/evidence/2026-06-23/react-window-fast-scroll-4x.json`,
    `playground/evidence/2026-06-23/tanstack-virtual-fast-scroll-4x.json`
...
- [x] Capture and store real browser evidence showing prepend shift `< 1px`
  - Evidence: `playground/evidence/2026-06-21/markdown-prepend-stability.json`
...
- [x] Capture and store real browser evidence showing resize shift `< 1px`
  - Evidence: `playground/evidence/2026-06-21/image-resize-high-variance.json`
...
- [x] Capture and store real browser evidence for each heterogeneous preset
  - Evidence:
    `playground/evidence/2026-06-21/markdown-fast-scroll-incomplete.json`,
    `playground/evidence/2026-06-21/image-resize-high-variance.json`,
    `playground/evidence/2026-06-21/heavy-fast-scroll-incomplete.json`
...
- [x] Capture and store Chrome CPU throttle 4x evidence JSON
  - Evidence: `playground/evidence/2026-06-21/plain-text-fast-scroll-4x.json`
